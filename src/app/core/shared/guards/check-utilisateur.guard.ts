...
/**
 * le CheckUtilisateurGuard n'as pas pour objectif de bloqué le route mais de charge l'utilisateur connecter
 */
@Injectable({ providedIn: 'root' })
export class CheckUtilisateurGuard implements CanActivate {
    constructor(
